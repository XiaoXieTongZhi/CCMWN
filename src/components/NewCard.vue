<template>
    <div class="new-card">
       ...
       <div class="color-card">
        <p class="color-li" v-for="(e,index) in cardcolortwo" :key="index" :style="{backgroundColor:e}" :class="{colorselected:index==selected}"  @click="changeColor(index)"></p>
       </div>
       <div class="card-main" :style="{backgroundColor: cardcolor[selected]}">
        <textarea placeholder="输入留言内容" class="message" maxlength="500"></textarea>
